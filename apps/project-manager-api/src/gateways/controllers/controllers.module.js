...
var projects_controller_1 = require("./projects/projects.controller");
var tasks_controller_1 = require("./tasks/tasks.controller");
var users_controller_1 = require("./users/users.controller");
var use_cases_module_1 = require("../../domain/use-cases/use-cases.module");
var ControllersModule = function () {
    ...
    var _classThis;
    var ControllersModule = _classThis = /** @class */ (function () {
        function ControllersModule_1() {
        }
        return ControllersModule_1;
    }());
    __setFunctionName(_classThis, "ControllersModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ControllersModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ControllersModule = _classThis;
}();
