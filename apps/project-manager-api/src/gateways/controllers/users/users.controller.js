...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        function UsersController_1(getUserUseCase, createUserUseCase) {
            this.getUserUseCase = (__runInitializers(this, _instanceExtraInitializers), getUserUseCase);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.getUserUseCase.execute(+id)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.createUserUseCase.execute(__assign({}, createUserDto))];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_2 = _a.sent();
