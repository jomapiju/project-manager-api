...
var ProjectEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('project')];
    ...
    var ProjectEntity = _classThis = /** @class */ (function () {
        function ProjectEntity_1() {
            ...
            this.user = (__runInitializers(this, _tasks_extraInitializers), __runInitializers(this, _user_initializers, void 0));
            __runInitializers(this, _user_extraInitializers);
        }
        return ProjectEntity_1;
    }());
    ...
    (function () {
        ...
        _description_decorators = [(0, typeorm_1.Column)({ name: 'description', nullable: false })];
        _tasks_decorators = [(0, typeorm_1.OneToMany)(function () { return task_entity_1.TaskEntity; }, function (task) { return task.project; })];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.UserEntity; }, function (user) { return user.projects; }), (0, typeorm_1.JoinColumn)()];
