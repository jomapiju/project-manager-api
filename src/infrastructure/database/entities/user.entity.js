...
var UserEntity = function () {
    ...
    var UserEntity = _classThis = /** @class */ (function () {
        function UserEntity_1() {
            ...
            this.projects = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _projects_initializers, void 0));
            this.tasks = (__runInitializers(this, _projects_extraInitializers), __runInitializers(this, _tasks_initializers, void 0));
    ...
    (function () {
        ...
        _firstName_decorators = [(0, typeorm_1.Column)({ name: 'firstName', nullable: false })];
        _lastName_decorators = [(0, typeorm_1.Column)({ name: 'lastName' })];
        _email_decorators = [(0, typeorm_1.Column)({ name: 'email', nullable: false })];
        _password_decorators = [(0, typeorm_1.Column)({ name: 'password', nullable: false })];
        _projects_decorators = [(0, typeorm_1.OneToMany)(function () { return project_entity_1.ProjectEntity; }, function (project) { return project.user; })];
        _tasks_decorators = [(0, typeorm_1.OneToMany)(function () { return task_entity_1.TaskEntity; }, function (task) { return task.user; })];
