...
var TaskEntity = function () {
    ...
    var TaskEntity = _classThis = /** @class */ (function () {
        function TaskEntity_1() {
            ...
            this.project = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _project_initializers, void 0));
    ...
    __setFunctionName(_classThis, "TaskEntity");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _name_decorators = [(0, typeorm_1.Column)({ name: 'name', nullable: false })];
        _status_decorators = [(0, typeorm_1.Column)({ name: 'status', nullable: false })];
        _project_decorators = [(0, typeorm_1.ManyToOne)(function () { return project_entity_1.ProjectEntity; }, function (project) { return project.tasks; }, {
                cascade: true,
                nullable: false,
            })];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.UserEntity; }, function (user) { return user.tasks; }), (0, typeorm_1.JoinColumn)()];
        ...
        TaskEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TaskEntity = _classThis;
}();
