...
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            providers: [create_user_service_1.CreateUserService, get_user_by_id_service_1.GetUserByIdService],
            exports: [create_user_service_1.CreateUserService, get_user_by_id_service_1.GetUserByIdService]
        })];
